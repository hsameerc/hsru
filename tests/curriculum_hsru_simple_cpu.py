...
def plot_hidden_states(model, data_args, title):
    ...
    plt.savefig(f"../plots/curriculum_lstm_vs_hsru_cpu/{title}.png")
...
def run_final_benchmark():
    ...
    print(f"\n| {'Curriculum Stage':<25} | {'LSTM Accuracy':<20} | {'HSRU Accuracy':<20} |")
    print(f"|{'-' * 27}|{'-' * 22}|{'-' * 22}|")
    ...
    plot_hidden_states(lif_model, curriculum[-1]["args"], "HSRU")
